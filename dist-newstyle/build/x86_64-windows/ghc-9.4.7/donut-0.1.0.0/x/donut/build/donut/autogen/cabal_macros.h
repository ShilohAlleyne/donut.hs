...
/* package donut-0.1.0.0 */
#ifndef VERSION_donut
#define VERSION_donut "0.1.0.0"
#endif /* VERSION_donut */
#ifndef MIN_VERSION_donut
#define MIN_VERSION_donut(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_donut */
...
#define CURRENT_COMPONENT_ID "donut-0.1.0.0-inplace-donut"
